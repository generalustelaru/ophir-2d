...
Coins (appear as silver coins with value) are the standard currency in the game and are involved in most transactional actions.

## Favor

Favor (red seal) is a special currency. You can spend it to enable actions and facilitate movement, among other things. It comes in short supply compared to coins.
...
### Favor and Movement
On your turn, as long as you have moves left, you may click once on the favor button to spend 1 favor and ignore all other ships during movement. With favor spent, you can move into occupied zones successfully, without making influence checks.
...
While you wouldn't want to drop anything generally, sometimes the contextual value of trade goods can change. What's more, action buttons whose effect would bring a new item onboard are disabled if there isn't enough room. Remember, gold and silver take up two spaces.

## Zone Actions

### Trade Good Zones
Four of the seven zones contain trade goods (gems, ebony, marble, or linen). Each one enables the following expendable action:
...
#### Market Card Anatomy
An assortment of trade goods and a coin value is displayed in the center. These depict an exact transaction that a player can make.
...
The temple (initially a dark blue edifice icon) is the focal point of the game. Here, players can donate metals for points and goods for variable amounts of points and favor.

The location enables the actions depicted in the bottom left area. There are two buttons for donating metal, one for donating trade goods, and one for upgrading your cargo. Tucked in the bottom left corner, a rectangular donations reference area keeps track of all the donated metals in the game.

#### Temple Zone Actions

**Action: Upgrade Cargo**: Click on the bottom upgrade cargo button to spend 2 coins and increase your cargo capacity by 1. This action is expendable, and can only be performed twice in the entire game (you can only increase cargo to 4).
