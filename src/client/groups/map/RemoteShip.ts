...
import { ClientEvent, EventKey, DynamicGroupInterface, EventType, RawEvents } from '~/client_types';
    ...
    constructor(
        ...
        this.group.on(RawEvents.DRAG_END, () => {
            ...
            if (targetZone != this.localZone) {
                ...
                const event: ClientEvent = { type: EventType.client, detail: { key: EventKey.client_message, message } };
